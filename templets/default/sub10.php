...
<div class="container">
    <table class="selection-screen">
        ...
        <tr>
            <th><span class="list-icon"></span> 2. 나는 한참 지난 후에야 비로소 내가 사랑하고 있다는 것을<br>
                <span class="indent-one">알았다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 3. 우리 사이의 일이 잘 풀리지 않으면 나는 소화가 잘 되지<br>
                <span class="indent-one">않는다.<span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 4. 사랑을 고백하기 전에 먼저 나의 장래 목표부터 생각해 보아야<br>
        ...
        <tr>
            <th><span class="list-icon"></span> 5. 좋아하는 마음이 얼마 동안 있은 후에야 사랑하는 마음이<br>
                <span class="indent-one">생기는 것이 원칙이다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 6. 애인에게 자신의 태도를 다소 불확실하게 해두는 것이 좋다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 7. 애인을 결정하기 전에 인생설계부터 잘해두는 것이 좋다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 8. 애인이 어려운 처지에 있으면 설사 그(혹은 그녀)가 바보 같은<br>
                <span class="indent-one">행동을 하더라도 힘껏 도와주려고 한다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 10. 비슷한 배경을 가진 사람끼리 사랑하는 것이 가장 좋다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 12. 대개 제일 먼저 나의 주의를 끄는 것은 그 사람의 외모이다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 14. 사랑에 빠지면 도무지 다른 일에는 정신을 집중하기가<br>
                <span class="indent-two">힘들다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 15. 그의 손을 잡았을 때 나는 사랑의 가능성을 감지했다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 16. 애인이 다른 사람하고 같이 있다는 생각이 들면 견딜 수가<br>
                <span class="indent-two">없다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 17. 나는 나의 애인 두 사람이 서로 알지 못하도록 교묘하게<br>
                <span class="indent-two">재주부린 적이 적어도 한번은 있다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 18. 나는 매우 쉽고 빠르게 사랑하던 관계를 잊어버릴 수 있다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 19. 애인이 원하는 것을 위해서라면 나는 기꺼이 내가 원하는<br>
                <span class="indent-two">것을 희생시킬 수 있다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 20. 키스, 포옹, 성관계는 서둘러서는 안 된다. 그것들은<br>
                <span class="indent-two">서로 충분히 친해지면 자연스럽게 이루어지는 것이다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 22. 연애를 시작하기 전부터 애인이 될 사람의 모습을 분명히<br>
                <span class="indent-two">정해 놓고 있다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 23. 우리가 언제부터 서로 사랑하게 되었는지 정확히 알 수 없다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 24. 결혼하지 않을 사람하고는 진정한 사랑을 할 수 없을 것 같다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 25. 내가 애인에게 방해가 된다면, 차라리 나는 그만 두겠다.</th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 26. 나는 애인의 것과 똑같은 옷, 모자, 자전거, 자동차 등을<br>
                <span class="indent-two">갖고 싶다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 27. 내가 가지고 있는 것은 무엇이든지 나의 애인이 마음대로<br>
                <span class="indent-two">써도 좋다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 28. 애인이 잠시라도 나에게 무관심해지면, 나는 그의 관심을<br>
                <span class="indent-two">끌기 위해 때로는 정말 바보 같은 짓을 할 때도 있다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 29. 깊이 사귀고 싶지 않더라도 어떤 상대가 나의 데이트 신청에<br>
                <span class="indent-two">응하는지를 시험해보는 것은 재미있을 것 같다.</span></th>
            <td class="selection-yn">
        ...
        <tr>
            <th><span class="list-icon"></span> 30. 배우자를 결정하는데 있어 가장 먼저 고려해야 할 점은<br>
                <span class="indent-two">그가 좋은 부모가 될 수 있는가 여부이다.</span></th>
            <td class="selection-yn">
